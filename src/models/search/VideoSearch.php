...
/**
 * VideoSearch represents the model behind the search form of `modava\video\models\Video`.
 */
class VideoSearch extends Video
{
    ...
    {
        return [
            [['id', 'video_type', 'video_category', 'position', 'status', 'views', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
